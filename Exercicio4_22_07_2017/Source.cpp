/*
Criar uma Lista que armazene os dados cadastrais das 
pessoas que compraram em uma determinada loja, usando uma lista encadeada. 
Sabendo que: 
	Nome (30 caracteres); 
	cpf (12 caracteres); 
	email (50 Caracteres) e
	telefone (12 Caracteres).
O programa deverá ter a possibilidade de pesquisar de forma sequencial 
um determinado cliente que a loja deseje.
*/
