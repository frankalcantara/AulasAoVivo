/*
Crie um programa para demonstrar um algoritmo de pesquisa binária. 
Utilize para testes um vetor de 10.000 números inteiros.
*/
/*
...
//para testar seu código, você pode usar apenas 20 números.
