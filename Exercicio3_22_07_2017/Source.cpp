...
a cada ocasião especial abre sua última aquisição poupando os mais antigos.
Sabendo se que as informações básicas que o registro deve conter são: 
	vinho (30 caracteres); 
	data (8 caracteres) e 
	Safra (um inteiro). 
Construa um programa que: 
	a. Permita incluir novos vinhos; 
	b. Informe qual vinho deverá ser aberto.
 */
